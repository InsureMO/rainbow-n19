...
import {AbstractNodeRecognizer} from './abstract-node-recognizer';
 ...
 */
export abstract class AbstractEagerNodeRecognizer extends AbstractNodeRecognizer {
	/**
	 ...
	 *
	 * @param parentTokenId token id of statement to create
	 * @param parentTokenType token type of statement to create
	 ...
	 */
	protected createParentAndGrabNodesTill(
		parentTokenId: TokenId, parentTokenType: TokenType,
	 ...
	 */
	protected createParentAndGrabNodesTillNewLine(
		parentTokenId: TokenId, parentTokenType: TokenType,
		recognition: AstRecognition,
		reviseGrabbedNode?: NodeReviseFunc): [GroovyAstNode, number] {
		return this.createParentAndGrabNodesTill(parentTokenId, parentTokenType, recognition, TokenId.NewLine, false, reviseGrabbedNode);
	}
}
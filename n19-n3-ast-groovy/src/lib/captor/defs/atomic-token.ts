...
export const AtomicTokenBasis: Readonly<Partial<{ [key in TokenId]: AtomicTokenBasisType }>> = {
	...
	// TODO duplicated with divide [TokenId.SlashyGStringQuotationMark]: [Tt.Sl, KwLt.SlashyGStringQuotationMark, 'LtSlashyGStringQuotationMark'],
	...
	[TokenId.MethodReference]: [Tt.Go, KwOp.MethodReference, 'GoMethodReference'],

...
export interface IRegexExprAltContext {
...
export class RegexExprAltContext extends ExpressionContext implements IRegexExprAltContext {
	...
	REGEX_FIND(): TerminalNode {
		return this.getToken(GroovyParser.REGEX_FIND, 0);
	}

	REGEX_MATCH(): TerminalNode {

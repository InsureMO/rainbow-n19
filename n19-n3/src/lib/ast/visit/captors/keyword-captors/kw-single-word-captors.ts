...
export const KwRecordCaptor = createSingleWordCaptor(AstKeywords.Record, KwRecordNode);
...
export const KwInterfaceCaptor = createSingleWordCaptor(AstKeywords.Interface, KwInterfaceNode);
export const KwClassCaptor = createSingleWordCaptor(AstKeywords.Class, KwClassNode);
export const KwAtInterfaceCaptor = createSingleWordCaptor(AstKeywords.AtInterface, KwAtInterfaceNode);
export const KwEnumCaptor = createSingleWordCaptor(AstKeywords.Enum, KwEnumNode);
export const KwTraitCaptor = createSingleWordCaptor(AstKeywords.Trait, KwTraitNode);

...
export const Tokens: { [key in keyof typeof TokenId]: Token } = {
	...
	GenericTypeDeclaration: {id: TokenId.GenericTypeDeclaration, name: 'GenericTypeDeclaration'},
	IfDeclaration: {id: TokenId.IfDeclaration, name: 'IfDeclaration'},
	IfIfDeclaration: {id: TokenId.IfIfDeclaration, name: 'IfIfDeclaration'},
	IfIfBody: {id: TokenId.IfIfBody, name: 'IfIfBody'},
	IfElseIfDeclaration: {id: TokenId.IfElseIfDeclaration, name: 'IfElseIfDeclaration'},
	IfElseIfBody: {id: TokenId.IfElseIfBody, name: 'IfElseIfBody'},
	IfElseDeclaration: {id: TokenId.IfElseDeclaration, name: 'IfElseDeclaration'},
	IfElseBody: {id: TokenId.IfElseBody, name: 'IfElseBody'},
	SwitchDeclaration: {id: TokenId.SwitchDeclaration, name: 'SwitchDeclaration'},
	SwitchCaseDeclaration: {id: TokenId.SwitchCaseDeclaration, name: 'SwitchCaseDeclaration'},
	SwitchCaseBody: {id: TokenId.SwitchCaseBody, name: 'SwitchCaseBody'},
	SwitchDefaultDeclaration: {id: TokenId.SwitchDefaultDeclaration, name: 'SwitchDefaultDeclaration'},
	SwitchDefaultBody: {id: TokenId.SwitchDefaultBody, name: 'SwitchDefaultBody'},
	WhileDeclaration: {id: TokenId.WhileDeclaration, name: 'WhileDeclaration'},
	WhileBody: {id: TokenId.WhileBody, name: 'WhileBody'},
	DoWhileDeclaration: {id: TokenId.DoWhileDeclaration, name: 'DoWhileDeclaration'},
	DoWhileBody: {id: TokenId.DoWhileBody, name: 'DoWhileBody'},
	ForDeclaration: {id: TokenId.ForDeclaration, name: 'ForDeclaration'},
	ForBody: {id: TokenId.ForBody, name: 'ForBody'},
	Closure: {id: TokenId.Closure, name: 'Closure'},
	LambdaDeclaration: {id: TokenId.LambdaDeclaration, name: 'LambdaDeclaration'},
	LambdaBody: {id: TokenId.LambdaBody, name: 'LambdaBody'},
	CodeBlock: {id: TokenId.CodeBlock, name: 'CodeBlock'},
	ArrayInitializer: {id: TokenId.ArrayInitializer, name: 'ArrayInitializer'}
};

...
DocsCollector.collect('java.security.SignatureException', [
	[/* class description */
	...
	[/* constructors */
		[/* constructor */ '<init>()', [
			[/* constructor description */
				[/* text */ 't', `Constructs a SignatureException with no detail message. A
 ...
 exception.`]
		...
		[/* constructor */ '<init>(java.lang.String)', [
			[/* constructor description */
				[/* text */ 't', `Constructs a SignatureException with the specified detail
 ...
 particular exception.`]
		...
		[/* constructor */ '<init>(java.lang.String,java.lang.Throwable)', [
			[/* constructor description */
				[/* text */ 't', `Creates a `],
				[/* inline code block */ 'i', `SignatureException`],

...
DocsCollector.collect('java.nio.FloatBuffer', [
	[/* class description */
		[/* text */ 't', `A float buffer.
 ...
 `],
   ...
   single floats; `]
			...
			[/* block */ 'b', [
				[/* block */ 'b', [
					[/* text */ 't', ` Absolute and relative `],
					[/* reference */ 'r', `#get(float%5B%5D)`, `bulk get`],
					[/* text */ 't', `
   ...
   into an array; and`]
			...
			[/* block */ 'b', [
				[/* block */ 'b', [
					[/* text */ 't', ` Absolute and relative `],
					[/* reference */ 'r', `#put(float%5B%5D)`, `bulk put`],
					[/* text */ 't', `
 ...
 content, by `],
			[/* reference */ 'r', `#wrap(float%5B%5D)`, `wrapping`],
			[/* text */ 't', ` an existing
 ...
 `]
		...
		[/* block */ 'b', [
			[/* text */ 't', ` Like a byte buffer, a float buffer is either `],
 ...
 current position, and then increments the position.`]
		...
		[/* method */ 'get(int)', [
			[/* method description */
				[/* text */ 't', `Absolute `],
				[/* text */ 't', `get`],
				[/* text */ 't', ` method.  Reads the float at the given
 index.`]
			],
			[/* parameters */
				[/* parameter */ 'index', [/* parameter description */
					[/* text */ 't', `The index from which the float will be read`]
				]]
			],
			[/* throws */
 ...
 `],
   ...
   equal, unlike `],
							[/* reference */ 'r', `java.lang.Float#equals(java.lang.Object)`, `Float.equals(Object)`],
							[/* text */ 't', `.
 ...
 this buffer and it is potentially much more efficient.`],
			...
			[/* parameters */
				[/* parameter */ 'dst', [/* parameter description */
					[/* text */ 't', `The array into which floats are to be written`]
				]],
         ...
         `],
				...
				[/* parameter */ 'length', [/* parameter description */
					[/* text */ 't', `The maximum number of floats to be written to the given
 ...
 `],
				[/* block */ 'b', [
					[/* text */ 't', ` This method transfers floats into this buffer from the given
 ...
 `]
		...
		[/* method */ 'put(int,java.nio.FloatBuffer,int,int)', [
			[/* method description */
				[/* text */ 't', `Absolute bulk `],
				[/* text */ 't', `put`],
				[/* text */ 't', ` method  `],
 ...
 `],
				[/* block */ 'b', [
					[/* text */ 't', ` This method transfers `],
					[/* inline code block */ 'i', `length`],
					[/* text */ 't', ` floats into this buffer from
 ...
 intermediate location before being written into this buffer.`],
        ...
        written; must be non-negative and less than `],
				...
				[/* parameter */ 'src', [/* parameter description */
					[/* text */ 't', `The buffer from which floats are to be read`]
				]],
				[/* parameter */ 'offset', [/* parameter description */
					[/* text */ 't', `The index within the source buffer of the first float to be
        read; must be non-negative and less than `],
					[/* inline code block */ 'i', `src.limit()`]
				]],
				[/* parameter */ 'length', [/* parameter description */
					[/* text */ 't', `The number of floats to be read from the given buffer;
        must be non-negative and no larger than the smaller of
        `],
					[/* inline code block */ 'i', `limit() - index`],
					[/* text */ 't', ` and `],
		...
		[/* method */ 'put(java.nio.FloatBuffer)', [
			[/* method description */
				[/* text */ 't', `Relative bulk `],
				[/* text */ 't', `put`],
				[/* text */ 't', ` method  `],
 ...
 `],
				[/* block */ 'b', [
					[/* text */ 't', ` This method transfers the floats remaining in the given source
 ...
 intermediate location before being written into this buffer.`],
			...
			[/* parameters */
				[/* parameter */ 'src', [/* parameter description */
					[/* text */ 't', `The source buffer from which floats are to be read;
 ...
 `],
		...
		[/* method */ 'wrap(float[])', [
			[/* method description */
				[/* text */ 't', `Wraps a float array into a buffer.

 `],
				[/* block */ 'b', [
					[/* text */ 't', ` The new buffer will be backed by the given float array;

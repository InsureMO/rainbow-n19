...
DocsCollector.collect('java.time.chrono.MinguoDate', [
	[/* class description */
		[/* text */ 't', `A date in the Minguo calendar system.
 `],
		[/* block */ 'b', [
			[/* text */ 't', `
 ...
 `],
				[/* block */ 'b', [
					[/* text */ 't', `
 Compares this `],
					[/* inline code block */ 'i', `MinguoDate`],
 ...
 This instance is immutable and unaffected by this method call.`]
		...
		[/* method */ 'getChronology()', [
			[/* method description */
				[/* text */ 't', `Gets the chronology of this date, which is the Minguo calendar system.
 `],
				[/* block */ 'b', [
					[/* text */ 't', `
 The `],
 ...
 allowing it to be used as a query via method reference, `],
			...
			[/* return description */
				[/* text */ 't', `the date in Minguo calendar system, not null`]
			]
		]],
		[/* method */ 'now()', [
			[/* method description */
 ...
 because the clock is hard-coded.`]
		...
		[/* method */ 'of(int,int,int)', [
			[/* method description */
				[/* text */ 't', `Obtains a `],
				[/* inline code block */ 'i', `MinguoDate`],
				[/* text */ 't', ` representing a date in the Minguo calendar
 ...
 The day must be valid for the year and month, otherwise an exception will be thrown.`]
			...
			[/* parameters */
				[/* parameter */ 'prolepticYear', [/* parameter description */
					[/* text */ 't', `the Minguo proleptic-year`]
				]],
				[/* parameter */ 'month', [/* parameter description */
					[/* text */ 't', `the Minguo month-of-year, from 1 to 12`]
				]],
				[/* parameter */ 'dayOfMonth', [/* parameter description */
					[/* text */ 't', `the Minguo day-of-month, from 1 to 31`]
				]]
			],
			[/* throws */
				[/* throw */ 'java.time.DateTimeException', [/* throw description */

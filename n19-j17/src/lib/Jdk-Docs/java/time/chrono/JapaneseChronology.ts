...
DocsCollector.collect('java.time.chrono.JapaneseChronology', [
	[/* class description */
		[/* text */ 't', `The Japanese Imperial calendar system.
 `],
		[/* block */ 'b', `
 ...
 `]
	...
	[/* fields */
		[/* field */ 'INSTANCE', [
			[/* field description */
				[/* text */ 't', `Singleton instance for Japanese chronology.`]
			],
		]]
	],
	/* constructors */ UDF,
 ...
 numeric values supported by `],
				[/* external link */ 'a', `JapaneseEra.html#of(int)`, `JapaneseEra.of(int)`],
				[/* text */ 't', `.`]
			],
			[/* parameters */

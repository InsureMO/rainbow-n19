...
DocsCollector.collect('java.util.function.LongPredicate', [
	[/* class description */
 ...
 otherwise `],
		...
		[/* method */ 'or(java.util.function.LongPredicate)', [
			[/* method description */
 ...
 predicate`]
		...
		[/* method */ 'and(java.util.function.LongPredicate)', [
			[/* method description */
				[/* text */ 't', `Returns a composed predicate that represents a short-circuiting logical

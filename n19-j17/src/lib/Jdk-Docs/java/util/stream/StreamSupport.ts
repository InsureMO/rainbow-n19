...
DocsCollector.collect('java.util.stream.StreamSupport', [
 ...
 `],
				[/* block */ 'b', [
					[/* text */ 't', `The `],
					[/* external link */ 'a', `../function/Supplier.html#get()`, `Supplier.get()`],
 ...
 more efficient to use `],
					[/* reference */ 'r', `stream(java.util.Spliterator, boolean)`],
					[/* text */ 't', `
 instead.
 `]
				]],
 ...
 `],
					[/* external link */ 'a', `package-summary.html#NonInterference`, `Non-Interference`],
					[/* text */ 't', ` for
 more details.`]
				]]
			],
 ...
 `],
					...
					[/* text */ 't', `.  Otherwise,
 `],
					[/* reference */ 'r', `stream(java.util.function.Supplier, int, boolean)`],
 ...
 `],
					...
					[/* text */ 't', `, it is likely
 more efficient to use `],
					[/* reference */ 'r', `intStream(java.util.Spliterator.OfInt, boolean)`],
					[/* text */ 't', `
 instead.
 `]
				]],
 ...
 `],
					...
					[/* text */ 't', `.  Otherwise,
 `],
					[/* reference */ 'r', `intStream(java.util.function.Supplier, int, boolean)`],
					[/* text */ 't', ` should be
 ...
 `],
					...
					[/* text */ 't', `, it is likely
 more efficient to use `],
					[/* reference */ 'r', `longStream(java.util.Spliterator.OfLong, boolean)`],
					[/* text */ 't', `
 instead.
 `]
				]],
 ...
 `],
					...
					[/* text */ 't', `.  Otherwise,
 `],
					[/* reference */ 'r', `longStream(java.util.function.Supplier, int, boolean)`],
					[/* text */ 't', ` should be
 used to reduce the scope of potential interference with the source.  See
 `],
					[/* external link */ 'a', `package-summary.html#NonInterference`, `Non-Interference`],
 ...
 `],
					...
					[/* text */ 't', `.  Otherwise,
 `],
					[/* reference */ 'r', `doubleStream(java.util.function.Supplier, int, boolean)`],
					[/* text */ 't', ` should
 ...
 `],
					...
					[/* text */ 't', `, it is likely
 more efficient to use `],
					[/* reference */ 'r', `doubleStream(java.util.Spliterator.OfDouble, boolean)`],
					[/* text */ 't', `
 instead.
 `]
				]],

...
JdkClassCreateHelper.class('java.nio.CharBuffer', [
	...
	[/* declared methods */
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.clear() */
			/* name */ 'clear',
			/* parameters */,
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.duplicate() */
			/* name */ 'duplicate',
			/* parameters */,
			/* return */ 'java.nio.Buffer',
			/* exceptions */,
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.flip() */
			/* name */ 'flip',
			/* parameters */,
			/* return */ 'java.nio.Buffer',
			/* exceptions */,
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.limit(int) */
			/* name */ 'limit',
			[/* parameters */
				[/* parameter */
					/* name */ 'arg0',
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.mark() */
			/* name */ 'mark',
			/* parameters */,
			/* return */ 'java.nio.Buffer',
			/* exceptions */,
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.position(int) */
			/* name */ 'position',
			[/* parameters */
				[/* parameter */
					/* name */ 'arg0',
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.reset() */
			/* name */ 'reset',
			/* parameters */,
			/* return */ 'java.nio.Buffer',
			/* exceptions */,
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.rewind() */
			/* name */ 'rewind',
			/* parameters */,
			/* return */ 'java.nio.Buffer',
			/* exceptions */,
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.slice() */
			/* name */ 'slice',
			/* parameters */,
			/* return */ 'java.nio.Buffer',
			/* exceptions */,
		...
		[/* public java.nio.Buffer java.nio.CharBuffer.slice(int,int) */
			/* name */ 'slice',
			[/* parameters */
				[/* parameter */
					/* name */ 'arg0',

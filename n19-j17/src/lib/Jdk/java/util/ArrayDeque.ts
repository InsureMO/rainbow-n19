...
JdkClassCreateHelper.class('java.util.ArrayDeque', [
	...
	[/* interfaces, implements java.util.Deque<E>, java.lang.Cloneable, java.io.Serializable */
		[/* parameterized type */ 'pt', [
			[/* actual argument types */
				[/* type variable ref */ 'tr', [/* name */ 'E']]
			],
	...
	[/* declared methods */
		...
		[/* public java.util.Spliterator<E> java.util.ArrayDeque.spliterator() */
			/* name */ 'spliterator',
			/* parameters */,
			/* return */ [/* parameterized type */ 'pt', [
				[/* actual argument types */
